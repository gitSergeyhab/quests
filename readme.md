Имя студента: Сергей Голик
Время затраченное на разработку проекта: 13 часов (еще часов пять убил на безуспешные попытки подружить стайлед-компонент и тайпскрип…)
